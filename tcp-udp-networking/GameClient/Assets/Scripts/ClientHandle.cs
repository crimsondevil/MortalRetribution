...
public class ClientHandle : MonoBehaviour
{
    ...
    public static void PlayerShootAt(Packet _packet)
    {
        int _id = _packet.ReadInt();
        Vector3 _shoot_orig = _packet.ReadVector3();
        Vector3 _shoot_dir = _packet.ReadVector3();
        string _shot_obj = _packet.ReadString();
        int _shot_id = _packet.ReadInt();
        //Debug.Log("PlayerShootAt");
        GameManager.players[_id].ShootFX(_id, _shoot_orig, _shoot_dir, _shot_obj, _shot_id);
    }
    ...
    public static void PlayerRespawned(Packet _packet)
    {
        ...
        GameManager.players[_id].Respawn(_id);
    }
    ...
    public static void ItemPickedUp(Packet _packet)
    {
        ...
        GameManager.players[_byPlayer].pickedUpItem(_byPlayer);
    ...
    public static void SpawnProjectile(Packet _packet)
    {
        ...
        GameManager.players[_thrownByPlayer].droppedItem(_thrownByPlayer);
    ...
    public static void EnemyShootAt(Packet _packet)
    {
        int _id = _packet.ReadInt();
        Vector3 _shoot_orig = _packet.ReadVector3();
        Vector3 _shoot_dir = _packet.ReadVector3();
        ...
        int _shot_id = _packet.ReadInt();
        //Debug.Log("PlayerShootAt");
        GameManager.enemies[_id].EnemyShootFX(_id, _shoot_orig, _shoot_dir, _shot_obj, _shot_id);
    }
    ...
    {
        int _num_all_killed = _packet.ReadInt();
        UIManager.instance.EndUI(_num_all_killed);
    }
}
